...
- [ ] `02-compute.yaml` stack deleted (live: `duokart-02-compute`) — confirm ALB + EC2 gone (biggest burner).
- [ ] VPC stack (live: `duokart-02-vpc`, built from `01-vpc.yaml`) deleted — confirm NAT Gateway gone (second burner).
