...
- [x] Budget `duokart-cap` ACTUAL Day-0: monthly fixed $10.00, status OK/Healthy, $0.00 actual / $0.08 forecast — screenshot `docs/screenshots/day-0/budget-cap.png` (2026-09-15). Interim per `docs/architecture-decisions.md` 2026-09-15 row — canonical guardrail stays $170 with $60 warn / $100 stop-and-destroy, to be applied before Day-1 NAT.
- [x] Billing owner: Swapnil. Who presses destroy: Swapnil
- [x] Empty EC2/RDS/ALB consoles in us-east-2 (screenshots `docs/screenshots/day-0/ec2-empty.png`, `rds-empty.png`, `alb-empty.png` — Ohio verified, no Account ID exposed)
