...
**Status:** Day 2 — ALB + ASG deployed. Next: Day 3 (RDS data tier).
...
- `docs/day-0-setup.md` → `docs/day-1-network.md` → `docs/day-2-compute.md` → `docs/day-3-data.md` — day docs
...
- [X] Day 0-2 screenshots in `docs/screenshots/`
